...
class CreateResource(BaseRepository):
    ...
    def create(self, instance, use_vpc=False, data=None, file_handler=None):
        instance_dict = self._get_instance_dict(instance)
        response = self._send_create_request(instance_dict, use_vpc=use_vpc, data=data, file_handler=file_handler)
        self._validate_response(response)
    ...
    def _send_create_request(self, instance_dict, use_vpc, data=None, file_handler=None):
        ...
        files = self._get_request_files(file_handler)
