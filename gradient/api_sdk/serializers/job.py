...
class JobSchema(BaseSchema):
    ...
    registry_username = marshmallow.fields.Str(dump_to="registryTargetUsername", load_from="registryTargetUsername")
    registry_password = marshmallow.fields.Str(dump_to="registryTargetPassword", load_from="registryTargetPassword")
