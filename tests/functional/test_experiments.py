...
class TestExperimentsCreateSingleNode(object):
    ...
    EXPECTED_HEADERS = api_client.default_headers.copy()
    ...
    @mock.patch("gradient.cli.experiments.experiments_commands.api_client.requests.post")
...
"""
    ...
    @mock.patch("gradient.cli.experiments.experiments_commands.api_client.requests.get")
...
class TestStartExperiment(object):
    ...
    @mock.patch("gradient.cli.experiments.experiments_commands.api_client.requests.put")
